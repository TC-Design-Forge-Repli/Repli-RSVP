...
import communicationOptionsSaga from './communicationOptions.saga';
...
export default function* rootSaga() {
  yield all([
    ...
    checkEventCodeSaga(),
    communicationOptionsSaga(),// POSTS guests communication options (email, phone, receive updates/reminders) 
